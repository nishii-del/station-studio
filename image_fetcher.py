...
_KNOWN_SUBWAY_STATIONS = {
    ...
    "外苑前", "国会議事堂前", "虎ノ門", "虎ノ門ヒルズ", "神谷町", "広尾", "乃木坂",
    ...
    "北参道", "中目黒", "祐天寺", "学芸大学", "都立大学",
    "大門", "御成門", "芝公園", "三田", "白金台", "目黒",
    # 大阪メトロ
    "心斎橋", "本町", "なんば", "淀屋橋", "梅田", "天王寺",
    "日本橋", "谷町四丁目", "谷町六丁目", "谷町九丁目",
    "堺筋本町", "長堀橋", "四ツ橋", "西梅田", "東梅田",
    "天満橋", "北浜", "肥後橋", "中津", "動物園前",
    # 神戸市営地下鉄
    "新神戸", "県庁前", "大倉山", "湊川公園", "三宮・花時計前",
    # 横浜市営地下鉄
    "東山田", "北山田", "センター南", "センター北", "中川", "日吉本町",
}
...
_TERMINAL_LANDMARKS = {
    ...
    "神戸": ["Kobe Sannomiya", "神戸三宮", "Kobe Port Tower"],
    "三ノ宮": ["Sannomiya station", "三宮駅", "Kobe Sannomiya"],
    ...
    "目黒": ["Meguro River", "目黒川", "目黒駅 アトレ"],
    "成田": ["Naritasan Shinshoji Temple", "成田山新勝寺", "成田 表参道"],
}
